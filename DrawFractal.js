...
function DrawFractal(isAutomate=false)
{
    ...
    if (speedInMilliSecond == null || speedInMilliSecond <= 0)
    {
        ...
        speedInMilliSecondID.value = speedInMilliSecond; 
    }
...
// On click methods for "CodePen"
let automateButton = document.querySelector('#automateButton'); 
let drawCircleButton = document.querySelector('#drawCircleButton'); 
let cancelTimer = document.querySelector('#cancelTimer'); 

automateButton.addEventListener('click', function()
{
    DrawFractal(true); 
    console.log('automateButton');
}); 
